...
Name: "{group}\ScreenProduceTool"; Filename: "{app}\ScreenProduceTool.exe"
Name: "{userdesktop}\ScreenProduceTool"; Filename: "{app}\ScreenProduceTool.exe"; Tasks: desktopicon;IconFilename: "{app}\Lonbon.ico" 
[Run]
