...
#define WM_EDIT_PRECOMMITTED	(WM_APP + 10003)

#define WM_LC_BN_CLICK	    (WM_USER + 300)

// Column Style
#define RC_COLUMN_STYLE_NONE           0x0000
#define RC_COLUMN_STYLE_TEXT           0x0001
#define RC_COLUMN_STYLE_TEXT_BUTTON    0x0002
#define RC_COLUMN_STYLE_CHECK_LEFT     0x0004
#define RC_COLUMN_STYLE_CHECK_CENTER   0x0008
#define RC_COLUMN_STYLE_EDITABLE       0x0010
#define RC_COLUMN_STYLE_COMBOBOX       0x0020
...
//////////////////////////////////////////////////////////////////////////
// The CHeaderData Class Definition
//////////////////////////////////////////////////////////////////////////
class CHeaderData
{
public:
...
public:		
	...
	///////////////////////////////////////////////////////////////////////
	CHeaderData* GetHeaderData(int nColumn);
	...
	//void SetColumnTextFormat(int nColumn = -1, UINT nFormat = DT_SINGLELINE);
	void SetHeaderMoveable(int nColumn = -1, BOOL bMoveable = TRUE);
	BOOL SetColumnExtendedStyle(int nColumn, DWORD dwStyle = RC_COLUMN_STYLE_TEXT);
	...
	void SetEditablePart(int nSubItem, BOOL bSet = TRUE) ;

	BOOL SetItemReserveData(int nItem, DWORD dwData1, DWORD dwData2) ;
	BOOL GetItemReserveData(int nItem, DWORD * pdwData1, DWORD * pdwData2) ;

	BOOL SetItemReserveData2(int nItem, DWORD dwData3, DWORD dwData4) ;
	BOOL GetItemReserveData2(int nItem, DWORD * pdwData3, DWORD * pdwData4) ;
	...
	BOOL SetItemButtonText(int nItem, int nSubItem, LPCTSTR lpszButtonText, LPCTSTR lpszSubItemText = TEXT("")) ;

	void SetItemBnNotifyWnd(HWND hNotifyWnd) ;
...
protected:
	...
	BOOL _IsValidColumn(int nColumn) const;
	...
	//BOOL m_bAllowEditPart ;
	CArray <BOOL, BOOL> m_arrayAllowEditPart;

	CFont m_fontLink;
	CFont m_fontNoLink;

	HWND m_hItemBnNotifyWnd;
	//////////////////////////////////////////////////////////////////////
...
protected:
	...
	void InitFont(BOOL bIsLink, CFont *pFont);
};
